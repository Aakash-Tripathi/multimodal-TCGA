...
if hasattr(os, "add_dll_directory"):
    with os.add_dll_directory(
        r"F:\Projects\multimodal-TCGA\lib\openslide-win64-20230414"
    ):
        import openslide
else:
    import openslide
...
def DrawMap(
    canvas, patch_dset, coords, patch_size, indices=None, verbose=0, draw_grid=True
):
    if indices is None:
...
def seg_and_patch(
    ...
    # just use the first slide for now
